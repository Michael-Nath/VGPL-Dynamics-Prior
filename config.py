...
def gen_args():
    ...
    if args.env == "RigidFall":
        ...
        args.physics_param_range = (-15.0, -5.0)
        ...
        args.mean_p = np.array([0.41318104, 0.29450318, 0.41318104])
        args.std_p = np.array([0.27079362, 0.21599858, 0.18200247])
        args.mean_d = np.array([-1.7060338e-04, -4.7716397e-04, 4.3661519e-05])
        args.std_d = np.array([0.00200962, 0.00208163, 0.00110157])
